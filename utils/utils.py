"""
Copied from Coding for Entrepreneurs course on Django:
Subscribe: https://www.youtube.com/@CodingEntrepreneurs
❤️
"""
import datetime
import os
...
"""
Alot of the userful functions that can be modfiied to fit your needs.
